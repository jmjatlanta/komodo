...
uint64_t komodo_paxcalc(int32_t height,uint32_t *pvals,int32_t baseid,int32_t relid,uint64_t basevolume,uint64_t refkmdbtc,uint64_t refbtcusd)
{
    ...
    if ( (pvalb= pvals[baseid]) != 0 )
    {
        ...
        else if ( (pvalr= pvals[relid]) != 0 )
        {
            ...
            printf("null pval for %s\n",komodo_currency(relid));
    } 
    else 
        printf("null pval for %s\n",komodo_currency(baseid));
    return 0;
}

uint64_t _komodo_paxprice(uint64_t *kmdbtcp,uint64_t *btcusdp,int32_t height,const char *base,
        const char *rel,uint64_t basevolume,uint64_t kmdbtc,uint64_t btcusd)
{
...
uint64_t _komodo_paxpriceB(uint64_t seed,int32_t height,const char *base,const char *rel,uint64_t basevolume)
{
...
uint64_t komodo_paxpriceB(uint64_t seed,int32_t height,const char *base,const char *rel,uint64_t basevolume)
{
...
int32_t komodo_paxprices(int32_t *heights,uint64_t *prices,int32_t max,const char *base,const char *rel)
{
