...
/***
 * Get the desired notary
 * @param notaryidp where to store the result
 * @param height
 * @param pubkey33 the pubkey
 * @param timestamp when
 * @returns -1 if not notary, 0 if notary, 1 if special notary
 */
...
int32_t komodo_MoMdata(int32_t *notarized_htp,uint256 *MoMp,uint256 *kmdtxidp,int32_t height,uint256 *MoMoMp,
        int32_t *MoMoMoffsetp,int32_t *MoMoMdepthp,int32_t *kmdstartip,int32_t *kmdendip);
