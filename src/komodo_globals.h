...
/**
 * @brief This determines which AdaptivePoW algorithm to use. Possible values are:
 * <= 0 turn AdaptivePoW off
 * 2 Use the TSA algorithm
 * anything else: AdaptivePoW on, but not TSA algo
 * @note the value is part of the network "magic" identifier, so 
 * should not be changed once chain is started
 */
